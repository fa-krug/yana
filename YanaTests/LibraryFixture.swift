...
enum LibraryFixture {
    ...
    static func make(articleCount: Int, feedCount: Int = 12, tagCount: Int = 8) throws -> Handle {
    ...
    /// Insert `count` articles from a background context and save — the shape of one aggregation
    /// batch landing in the store.
