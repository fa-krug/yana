...
struct ArticleStoreIncrementalTests {
    ...
    /// On a store a local save posts `.NSPersistentStoreRemoteChange` as
    ...
    @Test func localSavesStillSpliceRatherThanReload() async throws {
        ...
        #expect(remoteChanges.value > 0,
                "expected a local save to post remote-change notifications")
