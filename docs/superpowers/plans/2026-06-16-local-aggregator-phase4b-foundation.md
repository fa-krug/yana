...
struct HTMLUtilsTests {
    @Test func sanitizeClassNamesRewritesClassAttr() throws {
        ...
        #expect(!html.contains("class=\"foo bar\""))
    }
    ...
    @Test func removeEmptyElementsDropsBlankParagraphs() throws {
        ...
        #expect(html.replacingOccurrences(of: "real", with: "").contains("<p>") == false)
    }

    @Test func removeImageByURLMatchesResponsiveVariant() throws {
        let doc = try HTMLUtils.parse("<img src=\"https://x.com/pic-780x438.jpg\"><p>body</p>")
        try HTMLUtils.removeImageByURL(doc, url: "https://x.com/pic.jpg")
        let html = try HTMLUtils.bodyHTML(doc)
